...
async function main() {
    ...
    data: {
      ...
      provider: {
        create: {
          ...
          description: 'Parque infantil indoor no Porto com atividades para crianças dos 1-12 anos. Espaço ideal para festas de aniversário com diversões, jogos e momentos únicos para as crianças.',
    ...
    data: {
      ...
      provider: {
        create: {
          ...
          businessType: 'CULTURAL_CENTER',
          description: 'O primeiro SPA infantil da Europa! Espaço de fantasia e magia concebido ao pormenor para meninas dos 4 aos 12 anos. Festas de Aniversário, Chá das Princesas, Spa e muito mais.',
    ...
    data: {
      ...
      provider: {
        create: {
          ...
          businessType: 'CULTURAL_CENTER',
          description: 'Espaço maravilhoso em Maia, ideal para festas de aniversário. Instalações espaçosas com monitores atenciosos e amigáveis. Espaço moderno e colorido com futebol, trampolins, karts, escorregas e muito mais.',
    ...
    data: {
      ...
      provider: {
        create: {
          ...
          businessType: 'CULTURAL_CENTER',
          description: 'Parque infantil coberto com entretenimento e atividades lúdicas, pensado para brincadeira livre, festas de aniversário e organização de eventos para crianças dos 3 aos 12 anos.',
    ...
    data: {
      ...
      provider: {
        create: {
          ...
          businessType: 'CULTURAL_CENTER',
          description: 'Arena de realidade virtual para festas de aniversário! Aventuras partilhadas em grupo para idades entre 6 e 18 anos. Experiências inesquecíveis com tecnologia de ponta.',
  ...
  if (!provider1Record || !provider2Record || !provider3Record || !provider4Record || !provider5Record) {
  ...
  const activity1 = await prisma.activity.create({
    data: {
      ...
      description: 'Festa de aniversário inesquecível no nosso parque infantil indoor! As crianças vão adorar brincar em todas as nossas atrações: escorregas, túneis, piscina de bolas, trampolins e muito mais. Inclui monitor, decoração, lanche e bolo. Um dia especial cheio de diversão e alegria para o seu pequeno tesouro.',
      shortDescription: 'Festa de aniversário completa para crianças dos 1 aos 12 anos',
      category: 'OTHER',
      ageMin: 1,
      ageMax: 12,
      duration: 180, // 3 hours
      capacity: 25,
      price: 15.50, // per child
      ...
      isActive: true,
      tags: ['festa', 'aniversário', 'indoor', 'trampolins', 'piscina de bolas'],
    },
  })
  ...
  const activity2 = await prisma.activity.create({
    data: {
      ...
      description: 'Uma festa de aniversário mágica no primeiro SPA infantil da Europa! As meninas vão viver um conto de fadas com tratamentos de spa, manicure, penteados e muito glamour. Inclui chá das princesas, maquilhagem e sessão fotográfica. Um sonho tornado realidade para a sua princesa.',
      shortDescription: 'Festa de princesas com spa e chá para meninas dos 4 aos 12 anos',
      category: 'OTHER',
      ageMin: 4,
      ageMax: 12,
      ...
      imageUrl: 'https://images.unsplash.com/photo-1464047736614-af324ba6ee22?w=800&h=600&fit=crop',
      requirements: 'Apenas para meninas. Recomendamos trazer roupa confortável para depois do spa.',
      included: 'Tratamentos de spa infantil, manicure, penteados, maquilhagem, chá das princesas com doces, sessão fotográfica e muita diversão num ambiente de fantasia.',
      isActive: true,
  ...
  const activity3 = await prisma.activity.create({
    data: {
      ...
      description: 'Festa de aniversário cheia de aventura no nosso parque colorido! Futebol, trampolins, karts, escorregas, escalada e muito mais numa instalação moderna e segura. Monitores experientes garantem diversão e segurança. Inclui lanche, bolo e lembrança para todos.',
      shortDescription: 'Festa aventura com atividades variadas dos 3 aos 12 anos',
      category: 'SPORTS',
      ageMin: 3,
      ageMax: 12,
      duration: 150, // 2.5 hours
      capacity: 20,
      price: 18.00, // per child
      ...
      included: 'Atividades variadas: futebol, trampolins, karts, escorregas, túneis, escalada. Monitores dedicados, lanche nutritivo, bolo de aniversário e lembranças.',
      isActive: true,
  ...
  const activity4 = await prisma.activity.create({
    data: {
      ...
      description: 'Festa de aniversário num ambiente acolhedor e criativo! Parque infantil coberto com atividades lúdicas e educativas. Oficinas criativas, jogos tradicionais e muita diversão numa atmosfera familiar. Perfeito para uma celebração especial e inesquecível.',
      ...
      included: 'Oficinas criativas, jogos educativos, atividades lúdicas, parque coberto, lanche saudável e ambiente familiar acolhedor.',
      isActive: true,
  ...
  const activity5 = await prisma.activity.create({
    data: {
      ...
      description: 'Festa de aniversário futurista com realidade virtual! Aventuras partilhadas em mundos virtuais incríveis. Experiência única e inovadora para adolescentes que procuram algo diferente. Inclui acesso VIP, consolas, jogos de tabuleiro e espaço para lanche.',
      ...
      requirements: 'Idade mínima 6 anos. Crianças com óculos devem informar previamente.',
      included: 'Aventuras em realidade virtual, acesso ao lounge VIP, consolas, jogos de tabuleiro, microondas e frigorífico disponíveis para lanche próprio.',
      isActive: true,
      tags: ['festa', 'aniversário', 'realidade virtual', 'tecnologia', 'inovador'],
    },
  })
  ...
  await prisma.review.create({
    data: {
      ...
      activityId: activity1.id,
      rating: 5,
      comment: 'A festa da Sofia foi perfeita! As crianças adoraram todas as atividades e os monitores foram fantásticos. Muito bem organizado e as crianças saíram exaustas de tanto brincar. Recomendo vivamente!',
      isVerified: true,
    },
  })
  ...
  await prisma.review.create({
    data: {
      ...
      activityId: activity2.id,
      rating: 5,
      comment: 'Experiência mágica no Princelandia! A Beatriz sentiu-se uma verdadeira princesa. O spa foi uma experiência única e ela ainda fala das amigas que fez lá. Voltaremos certamente!',
      isVerified: true,
    },
  })
  ...
  await prisma.review.create({
    data: {
      ...
      activityId: activity3.id,
      rating: 4,
      comment: 'Excelente festa no YupiColor! O Miguel adorou os trampolins e karts. Instalações muito limpas e seguras. Os monitores foram muito atenciosos. Única observação: podiam ter mais variedade no lanche.',
      isVerified: true,
    },
  })

  console.log('✅ Database seeded successfully with real Porto/Matosinhos data!')
  console.log(`
📊 Created:
- 2 parents
- 3 children  
