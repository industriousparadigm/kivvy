...
export const metadata: Metadata = {
  ...
  description: 'Encontre respostas para as suas perguntas sobre a KidsHiz. Suporte completo para pais e prestadores.',
};
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Centro de Ajuda</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Encontre respostas rápidas para as suas questões ou entre em contacto connosco.
          </p>
        </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {category.questions.map((faq, faqIndex) => (
                        <div key={faqIndex} className="border-l-4 border-gray-200 pl-4 hover:border-blue-400 transition-colors">
        ...
        {/* Quick Links */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-gray-900 text-center mb-8">Links Úteis</h2>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Configurações e preferências</p>
                    </div>
                  </div>
                  <ChevronRight className="h-5 w-5 text-gray-400" />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Políticas e privacidade</p>
                    </div>
                  </div>
                  <ChevronRight className="h-5 w-5 text-gray-400" />
                </div>
        ...
        {/* Contact Support */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-gray-900 text-center mb-8">Ainda Precisa de Ajuda?</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">Fale connosco em tempo real</p>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center gap-2">
                    ...
                    <a href="#" className="hover:text-blue-600 transition-colors">Como escolher a atividade certa</a>
                  </li>
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4" />
                    <a href="#" className="hover:text-blue-600 transition-colors">Dicas de segurança</a>
                  </li>
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4" />
                    <a href="#" className="hover:text-blue-600 transition-colors">Gestão de múltiplas crianças</a>
                  </li>
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4" />
                    <a href="#" className="hover:text-blue-600 transition-colors">Políticas de cancelamento</a>
                  </li>
                </ul>
              </div>
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4" />
                    <a href="/provider/signup" className="hover:text-blue-600 transition-colors">Como juntar-se à KidsHiz</a>
                  </li>
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4" />
                    <a href="/provider/resources" className="hover:text-blue-600 transition-colors">Recursos para prestadores</a>
                  </li>
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4" />
                    <a href="#" className="hover:text-blue-600 transition-colors">Melhores práticas</a>
                  </li>
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4" />
                    <a href="/provider/support" className="hover:text-blue-600 transition-colors">Suporte para prestadores</a>
                  </li>
                </ul>
              </div>
            </div>
