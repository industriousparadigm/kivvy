    ...
    return (
      <div className="text-center py-12 px-4">
        <div className="mb-6 relative">
          ...
          <div className="absolute -top-2 -left-8 text-2xl animate-pulse opacity-60">💙</div>
          <div className="absolute top-4 -right-6 text-xl animate-bounce opacity-60">✨</div>
        </div>
    ...
    return (
      <div className="text-center py-16 px-4">
        <div className="mb-8 relative">
          ...
          <div className="text-6xl mb-4">🔧</div>
          <div className="absolute -top-4 -left-8 text-2xl animate-bounce opacity-60">⚙️</div>
          <div className="absolute top-2 -right-8 text-xl animate-pulse opacity-60">🛠️</div>
          <div className="absolute -bottom-2 left-4 text-lg animate-bounce delay-300 opacity-60">✨</div>
        </div>
        ...
        <p className="text-gray-600 max-w-lg mx-auto leading-relaxed mb-8">
          Os nossos pequenos elfos estão a trabalhar para tornar tudo mais mágico. 
          Voltaremos em breve com algo incrível!
        </p>
  ...
  return (
    <div className="text-center py-12 px-4">
      <div className="mb-6 relative">
        ...
        <div className="text-6xl mb-4">😟</div>
        <div className="absolute -top-4 -left-6 text-2xl animate-pulse opacity-60">💫</div>
        <div className="absolute top-2 -right-8 text-xl animate-bounce opacity-60">
          <Heart className="h-6 w-6 text-pink-400" />
        </div>
        <div className="absolute -bottom-2 left-2 text-lg animate-bounce delay-300 opacity-60">🌟</div>
      </div>
