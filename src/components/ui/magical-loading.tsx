  ...
  if (variant === 'card') {
    return (
      <div className="h-96 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute top-6 left-6 text-2xl animate-bounce opacity-60">
          ✨
        </div>
        <div className="absolute top-8 right-8 text-xl animate-pulse opacity-60">
          🌟
        </div>
        <div className="absolute bottom-6 left-8 text-lg animate-bounce delay-300 opacity-60">
          💫
        </div>
        <div className="absolute bottom-8 right-6 text-xl animate-pulse delay-500 opacity-60">
          🎪
        </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12">
      ...
      <div className="relative mb-6">
        <div className="absolute -top-4 -left-4 text-2xl animate-bounce opacity-70">
          🎨
        </div>
        <div className="absolute -top-2 -right-6 text-xl animate-pulse opacity-70">
          ✨
        </div>
        <div className="absolute -bottom-4 left-2 text-lg animate-bounce delay-300 opacity-70">
          🌈
        </div>
