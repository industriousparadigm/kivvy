...
export function initializeWorkers() {
  ...
  notificationQueue.process('send-push-notification', 10, processPushNotificationJob);
  notificationQueue.process('send-booking-reminder', 5, processBookingReminderJob);
  ...
  maintenanceQueue.process('cleanup-expired-sessions', 1, processMaintenanceJob);
...
function setupEventHandlers() {
  const queues = [emailQueue, notificationQueue, paymentQueue, reportQueue, maintenanceQueue];
